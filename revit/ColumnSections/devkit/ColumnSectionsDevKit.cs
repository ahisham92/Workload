...
//  already imported.
//
//  ONE LINE MAY NEED CHANGING: the one marked >>> below, which is how this
//  gets hold of the document. Keep whichever version compiles.
// ===========================================================================

// >>> Keep the line that compiles in your tool, delete the other three. <<<
